...
create_mapping(uint64 *pgtbl, uint64 va, uint64 pa, uint64 sz, int perm) {
   ...
   for(int i = 0; i < page_num; i++) {
        uint64 vpn2 = (va + i * 0x1000) >> 30;
        uint64 vpn1 = (va + i * 0x1000) >> 21;
        uint64 vpn0 = (va + i * 0x1000) >> 12;

        uint64 ppn2 = (pa + i * 0x1000) >> 30;
        uint64 ppn1 = (pa + i * 0x1000) >> 21;
        uint64 ppn0 = (pa + i * 0x1000) >> 12;
