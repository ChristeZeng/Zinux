...
void setup_vm(void) {
    ...
    */
    ...
    unsigned long index = PHY_START & 0x0000007FC0000000;
    //其中存放的是0x80000000的高于30位
    early_pgtbl[index] = (PHY_START & 0xFFFFFFFFFFFFF000) | 0xF;

    unsigned long VA = PHY_START + PA2VA_OFFSET;
    index = VA & 0x0000007FC0000000;
    early_pgtbl[index] = (VA & 0xFFFFFFFFFFFFF000) | 0xF;
