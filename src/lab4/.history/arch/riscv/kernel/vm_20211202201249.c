...
void setup_vm_final(void) {
    ...
    create_mapping((uint64*)swapper_pg_dir, VM_START + OPENSBI_SIZE + (uint64)_sdata - (uint64)_stext, PHY_START + OPENSBI_SIZE + (uint64)_sdata - (uint64)_stext, (uint64)_ekernel - (uint64)_sdata, 3);
