...
void setup_vm_final(void) {
    ...
    create_mapping((uint64*)swapper_pg_dir, VM_START + OPENSBI_SIZE, PHY_START + OPENSBI_SIZE, (uint64)_srodata - (uint64)_stext, 3);
    ...
    create_mapping((uint64*)swapper_pg_dir, VM_START );
